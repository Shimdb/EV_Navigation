...
### Frontend
*   [여기에 사용하실 프론트 기술을 적어주세요. 예: HTML/CSS, Vanilla JS, React 등]
*   **Map API:** [Kakao Map API / Naver Map API]

### database: MySQL (Spatial Data Type `POINT` 활용)
...
```bash
git clone [https://github.com/](https://github.com/)[본인아이디]/ev-nav.git
